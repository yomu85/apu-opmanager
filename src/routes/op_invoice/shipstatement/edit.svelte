  ...
  <table class="table_line">
    ...
    <tr>
      ...
      <td>
        <div class="rdo_area">
          <div class="rdo_label">
            <input type="radio" name="completedStatus" class="form-control" id="status1"  checked>
            <label for="status1">전체</label>
          </div>
          <div class="rdo_label">
            <input type="radio" name="completedStatus" class="form-control" id="status2">
            <label for="status2">완료</label>
          </div>
          <div class="rdo_label">
            <input type="radio" name="completedStatus" class="form-control" id="status3">
            <label for="status3">미완료</label>
          </div>
        </div>
      </td>
    </tr>
