<svelte:head>
  <title>납품서 조회/수정 | 공급사</title>
</svelte:head>

<!-- 페이지 영역 -->
<h3><span>납품서 조회/수정</span></h3>
  ...
  <table class="table_line">
    ...
    <tr>
      ...
      <td colspan="5">
        <div class="rdo_area">
          <div class="rdo_label">
            <input type="radio" name="orderStatus" class="form-control" id="status1"  checked>
            <label for="status1">결재중</label>
          </div>
          <div class="rdo_label">
            <input type="radio" name="orderStatus" class="form-control" id="status2">
            <label for="status2">결재반려</label>
          </div>
          <div class="rdo_label">
            <input type="radio" name="orderStatus" class="form-control" id="status3">
            <label for="status3">주문생성</label>
          </div>
          <div class="rdo_label">
            <input type="radio" name="orderStatus" class="form-control" id="status4">
            <label for="status4">납품생성</label>
          </div>
          <div class="rdo_label">
            <input type="radio" name="orderStatus" class="form-control" id="status5">
            <label for="status5">납품거부</label>
          </div>
        </div>
      </td>
    </tr>
...
<div class="wj-content_wrap">
  <div class="btn_box between">
    ...
    <div class="flex_box">
      ...
      <button type="button" class="btn btn-default">거래명세서 출력</button>
  ...
  <div id="contentGridEl" class="wj-control wj-content wj-flexgrid" style="position: relative;">
    <div style="position: absolute; top: 50%; transform: translateY(-50%); width: 100%; height: auto; font-size:50px; text-align: center;">
      ...
      <div class="btn_box">
        ...
        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#enterReason1Modal">지연사유 입력</button>
        ...
        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#requestsModal">요청사항</button>
        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#attachmentsModal">첨부파일</button>
      </div>
    </div>
  </div>
  <!-- //wijmo area -->
...
<!-- 지연사유 입력 Modal -->
<div class="modal fade" id="enterReason1Modal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal_md modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">지연사유 입력</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true"><img src="/content/opmanager/images/pop_close.svg" alt="close"></span>
        </button>
      </div>
        ...
        <table class="table_line">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <textarea cols="30" rows="10" style="height: 9.4rem">
납품 전 연락부탁드립니다. 
줄바꿈 되고 줄바꿈되고 
스크롤 생성되고 
납품 전 연락부탁드립니다. 
...
<div class="modal fade" id="requestsModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal_md modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="txta_result" style="min-height: 67px; max-height: 130px;">
          납품 전 연락부탁드립니다. <br>
          줄바꿈 되고 줄바꿈되고<br>
          스크롤 생성되고 <br>
          납품 전 연락부탁드립니다.<br>
...
<div class="modal fade" id="attachmentsModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal_md modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="table_sticky_wrap" style="max-height:226px">
          <table class="table_sticky">
            ...
            <tbody>
              ...
              <tr>
                <td class="txt_left"><a href="#" class="txt_dnld">프리즈마팁&amp;전극.pdf</a></td>
                <td>12MB</td>
                <td>상태</td>
              </tr>
              <tr>
