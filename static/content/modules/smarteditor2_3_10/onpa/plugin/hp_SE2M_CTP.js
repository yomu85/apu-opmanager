...
nhn.husky.SE2M_CTP = jindo.$Class({		
	name : "SE2M_CTP",

	$init : function(){},
	
	$ON_MSG_APP_READY : function(){
		this.oApp.exec("REGISTER_UI_EVENT", ["ctp_attach", "click", "CTP_OPEN_WINDOW"]);
	},
	...
	makePopupURL : function(){
		//var sPopupUrl = "./onpa/popup/upload-ctp.jsp";
		var sPopupUrl = "/smarteditor/upload-ctp";
	 ...
	 * 팝업에서 호출되는 메세지.
	 */
	$ON_SET_CTP : function(aPhotoData){
